...
if(WIN32)
    ...
    list(APPEND SDL2_LIBS ${_SDL2TTF_LIB})
    find_library(_SDL2IMAGE_LIB SDL2_image)
    list(APPEND SDL2_LIBS ${_SDL2IMAGE_LIB})
    find_library(_SDL2MIXER_LIB SDL2_mixer)
    list(APPEND SDL2_LIBS ${_SDL2MIXER_LIB})

    mark_as_advanced(SDL2_INCLUDE_DIRS _SDL2_LIB _SDL2main_LIB _SDL2TTF_LIB _SDL2MIXER_LIB _SDL2IMAGE_LIB)
